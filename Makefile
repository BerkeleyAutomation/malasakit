...
LINT_TARGETS=cafe/settings.py cafe/urls.py cafe/wsgi.py pcari/management/commands/__init__.py pcari/management/commands/cleantext.py pcari/management/commands/makemessages.py pcari/models.py pcari/signals.py pcari/urls.py pcari/admin.py pcari/views.py

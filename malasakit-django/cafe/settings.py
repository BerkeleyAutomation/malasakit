...
# This should be an initially empty destination directory for collecting your static files from 
# their permanent locations into one directory for ease of deployment

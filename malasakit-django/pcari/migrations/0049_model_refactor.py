...
def standardize_comment_messages_forward(apps, schema_editor):
    ...
    # One-time use only! Disable for testing purposes.
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField('Comment', 'question',
                            models.ForeignKey('QualitativeQuestion', on_delete=models.CASCADE, default=None), preserve_default=False),
        ...
        migrations.AddField('Comment', 'respondent',
                            models.ForeignKey('Respondent', on_delete=models.CASCADE, default=None), preserve_default=False),
        ...
        migrations.AddField('CommentRating', 'comment',
                            models.ForeignKey('Comment', on_delete=models.CASCADE, default=None), preserve_default=False),
